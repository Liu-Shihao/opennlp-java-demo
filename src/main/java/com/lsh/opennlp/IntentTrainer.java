...
public class IntentTrainer {
    public static void main(String[] args) throws Exception {
        ...
        String path = "/Users/liushihao/IdeaProjects/opennlp-java-demo/example/weather/train";
        ...
        InputStream modelIn = new FileInputStream("/Users/liushihao/IdeaProjects/opennlp-java-demo/model/en-token.bin");
